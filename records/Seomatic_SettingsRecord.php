...
-------------------------------------------------------------------------------- */
            ...
            'siteSeoShowIdentity'               => array(AttributeType::Bool, 'default' => null),
            'siteSeoShowWebsite'                => array(AttributeType::Bool, 'default' => null),
            'siteSeoShowPlace'                  => array(AttributeType::Bool, 'default' => null),
            'siteSeoShowMainEntity'             => array(AttributeType::Bool, 'default' => null),
...
-------------------------------------------------------------------------------- */
            ...
            'facebookAdminId'                   => array(AttributeType::String, 'maxLength' => 255, 'default' => ''),
